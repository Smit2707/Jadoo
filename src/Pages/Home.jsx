  ...
  return (
    <div className='min-h-[80vh] mt-10  w-full flex-col md:flex lg:flex-row px-4 sm:px-6 lg:px-8'>
      <div className='left w-full lg:w-1/2 flex flex-col md:justify-start md:gap-2 space-y-6 py-8 lg:py-20'>
        ...
        <h1 className='text-[#030000] text-3xl sm:text-4xl lg:text-6xl text-center lg:text-start font-bold '>
          Travel, <span className='text-orange-600 font-extrabold pb-2'>Enjoy</span> and live a new and full life.
        </h1>
